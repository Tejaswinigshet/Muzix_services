package com.stackroute.muzixservices.controller;


        import com.fasterxml.jackson.databind.ObjectMapper;
        import com.stackroute.muzixservices.domain.Track;
        import com.stackroute.muzixservices.exception.TrackAlreadyExistsException;
        import com.stackroute.muzixservices.service.TrackService;
...
public class MuzixControllerTest {
    ...
    public void setUp() {
        ...
        track = new Track();
        track.setTrackID(15);
        track.setTrackComments("Singer:Sonu Nigam");
        track.setTrackName("Onde Ondu Sari");
        list = new ArrayList();
        list.add(track);
    }
